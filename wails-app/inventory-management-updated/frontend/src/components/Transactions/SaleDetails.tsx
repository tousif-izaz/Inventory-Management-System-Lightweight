...
export const SaleDetails = ({ sale, onUpdatePaymentStatus, onRefund }: SaleDetailsProps) => {
    const handleViewReceipt = async () => {
        try {
            console.log('Fetching receipt for sale ID:', sale.sale_id);
            ...
            const url = `http://localhost:37285/api/sales/${sale.sale_id}/receipt`;
            ...
            alert(`Failed to open receipt: ${error instanceof Error ? error.message : 'Unknown error'}`);
        }
    };
